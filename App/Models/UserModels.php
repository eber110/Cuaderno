    ...
    if (isset($card["content"]) && is_array($card["content"])) {
      foreach ($card["content"] as &$item) {
        ...
        if (($item["type"] ?? "") === "campaign") {
          ...
          $item["text_align"]     = in_array($item["text_align"] ?? "", ["left", "center", "right"], true) ? $item["text_align"] : "center";
          $item["title_size"]     = in_array($item["title_size"] ?? "", ["small", "medium", "large"], true) ? $item["title_size"] : "large";
          $item["desc_size"]      = in_array($item["desc_size"] ?? "", ["small", "medium", "large"], true) ? $item["desc_size"] : "medium";
          ...
          $item["btn_bg_color"]         = !empty($item["btn_bg_color"]) ? $item["btn_bg_color"] : ($card["back"] ?? "#595a83");
          $item["btn_text_color"]       = !empty($item["btn_text_color"]) ? $item["btn_text_color"] : ($card["color"] ?? "#ffffff");
          $item["countdown_bg_color"]   = !empty($item["countdown_bg_color"]) ? $item["countdown_bg_color"] : "#24252a";
          $item["countdown_text_color"] = !empty($item["countdown_text_color"]) ? $item["countdown_text_color"] : "#ffffff";
          $item["countdown_text_size"]   = in_array($item["countdown_text_size"] ?? "", ["small", "medium", "large"], true) ? $item["countdown_text_size"] : "medium";
          $item["countdown_widget_size"] = in_array($item["countdown_widget_size"] ?? "", ["small", "medium", "large"], true) ? $item["countdown_widget_size"] : "medium";
          ...
          $item["desc"]           = $item["desc"] ?? "";
          $item["button_text"]    = !empty(trim((string)($item["button_text"] ?? ""))) ? trim((string)$item["button_text"]) : "Suscribirme";
          $item["name"]           = $item["name"] ?? "";
