<header class="container observer container-xl-mid container-sml flex-row center-center flex-column-sml center-center-sml gap-sml-30 h-dvh-desk hpxmin-mid-1000 pb100 pt-mid-100 pb-mid-100 pt-sml-50 pb-sml-50">
  ...
  <div class="w100 flex-column center-center |m-mid-15">
    <div class="br30 p20 back8 wpx400 wpx-mid-350 w-sml-80 |hpx800 |hpx-mid-800 |hpx-sml-420 slide-in-right ob-0 dl-300 animate-slow image-gallery gallery-slide gallery-slide-continuous z-index-20 shadow" data-autoplay="3000">
      ...
      <div class="gallery-main pb1 br30">
        ...
        <img src="<?= DIR_UPLOAD_MEDIA_STATIC."hero2.webp"?>" alt="" class="gallery-item |animate-img-hero2 |absolute |hover-lift-ns">
        <img src="<?= DIR_UPLOAD_MEDIA_STATIC."hero3.webp"?>" alt="" class="gallery-item |animate-img-hero3 |absolute |hover-lift-ns">
        <img src="<?= DIR_UPLOAD_MEDIA_STATIC."hero4.webp"?>" alt="" class="gallery-item |animate-img-hero4 |absolute |hover-lift-ns">
      </div>
      <div class="flex-row center-center pt10"><span class="back7 p10 pl30 pr30 br50"></span></div>
    </div>
  </div>
</header>