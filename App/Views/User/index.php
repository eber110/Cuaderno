...
?>
<div class="container-xl container-xl-sml flex-column center-center text-protected" style="background-color: oklch(from <?= $card["backCard"][0]?> calc(l * 0.98) calc(c - 0.02) h);">
