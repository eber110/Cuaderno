...
<div id="<?= $campaignId ?>" data-content-index="<?= $dataContent ?>" class="campaign-block-wrapper |theme-button w100 flex-column position-relative <?= $sizeClass ?> <?= $borderCard ?> <?= $shadowCard ?>" style="background-color: <?= $bgColor?>;">
